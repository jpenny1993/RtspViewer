...
namespace RtspViewer.RawFramesDecoding.FFmpeg
{
    class FFmpegDecodedVideoScaler
    {
            ...
            TransformParameters transformParameters)
        {
            ...
            PixelFormats scaledPixelFormat = transformParameters.TargetFormat;
        ...
        private static FFmpegPixelFormat GetFFmpegPixelFormat(PixelFormats pixelFormat)
        {
            if (pixelFormat == PixelFormats.Bgra32)
                return FFmpegPixelFormat.BGRA;
            if (pixelFormat == PixelFormats.Grayscale)
